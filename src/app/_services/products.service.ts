...
export class ProductsService {
  ...
  public addProductImage(productImage: any): Observable<any> {
    return this.http.post(`${this.apiBaseUrl}/productimage/add`, productImage, { observe: 'response' });
  }
  public updateProductImage(productId: number, productImageDto: any): Observable<any> {
    return this.http.put<File[]>(`${this.apiBaseUrl}/productimage/update/${productId}`, productImageDto, { observe: 'response' });
  }
